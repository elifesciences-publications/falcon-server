...
namespace g2 {
   namespace internal {
      ...
      std::atomic<bool> g_log_level_status[8]{{true},{true},{true},{true},{true},{true},{true},{true}};
#endif	
   } // internal
   ...
   void setLogLevel(LEVELS log_level, bool enabled) {
      assert(internal::g_level_size == 8 && "Mismatch between number of logging levels and their use");
